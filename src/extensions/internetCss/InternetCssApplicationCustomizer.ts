...
import * as strings from 'InternetCssApplicationCustomizerStrings';
...
@override
  ...
  public CustomHeader(){
    this.context.placeholderProvider.placeholderNames.map((placeholdername)=>{
      ...
      SPComponentLoader.loadCss('https://24cl8t.sharepoint.com/sites/Dev/SiteAssets/InternetPortal.css');
    })
    this.context.placeholderProvider.tryCreateContent(
      PlaceholderName.Bottom
    ).domElement.innerHTML="<div style='background-color:#0063ae;height:35px;color:white;'>Copyright © 2023 - Zelarsoft, All Rights Reserved</div>"
     return Promise.resolve();
  }
}